...
export default function MemeCard() {
  return (
    <div className="max-w-sm bg-orange-500 rounded-lg text-center my-4 relative">
        <div className="absolute right-2 top-2">
            <img src={FavoriteIcon} alt="download" className="mb-2 w-[30px]"/>
            <img src={DonwloadIcon} alt="download" className="w-[30px]"/>
        </div>
      <div>
        <img
